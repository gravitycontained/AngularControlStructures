...
@Component({
  selector: 'app-kontrollstrukturen',
  templateUrl: './kontrollstrukturen.component.html',
  styleUrls: ['./kontrollstrukturen.component.css']
})
export class KontrollstrukturenComponent {
